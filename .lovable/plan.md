...
1. **Conectar o gatilho.** Hoje a timeline salva a etapa direto no banco e nunca chama o e-mail. Ao marcar uma etapa como *Concluída*, a timeline passará a chamar a função de servidor de celebração (etapa anterior → etapa concluída). Falha de e-mail nunca bloqueia o salvamento da etapa.
